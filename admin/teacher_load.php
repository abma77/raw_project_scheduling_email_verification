...
<body class="bg-light">
        ...
        <div class="position-relative main-content" id="plot-content" style="width: 100%;">
            ...
            <div class="row g-2 px-3 my-2">
                <div class="col-lg-4 col-12">
                    <div class="card shadow-sm rounded-0 border-0">
                        <div class="card-header">
                            <strong>Teacher's Load <i class="bi bi-kanban h5"></i></strong>
                        </div>
                        <div class="card-body">
                            <div class="my-2">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-2 text-center">
                                        ...
                                        <select name="" id="teacher-load-select-teacher"
                                            class="form-select rounded-0 shadow-none">
                ...
                <div class="col-lg-8 col-12">
                    <div class="card shadow-sm rounded-0 border-0">
                        <div class="card-header">
                            <strong>Teacher's Load Data <i class="bi bi-layout-text-window h5"></i></strong>
                        </div>
                        <div class="card-body">
    ...
    <script>
        $(function () {
            $("#teacher-load-select-teacher").select2();
        });
    </script>
