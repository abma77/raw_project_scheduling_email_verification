    ...
    if (!empty($_POST["submit"])) {
        ...
        if ($check_username->fetch()) {
            ...
            try {
                ...
                $mail->Body = 'Here is the verification link <b><a href="http://ctusched.live/raw_project_scheduling_email_verification/index.php?verification=' . $code . '">http://ctusched.live/raw_project_scheduling_email_verification/login_page.php?verification=' . $code . '</a></b>';
