            ...
            <div class="my-2">
                <form id="update-schedule-form">
                    <div class="my-2">
                        ...
                        <select required name="schedule_room" class="form-select shadow-none rounded-0">
                            <?php
                            ...
                            while ($rooms = $retrieve_rooms->fetch()) {
                                if ($rooms["room_name"] == $row["schedule_room"]) {
                                    ...
                                    echo '
                                            <option value="' . $row["room_name"] . '" selected>' . $row["room_name"] . '</option>
                                        ';
                                }
                            }
                            ?>
                    ...
                    <div class="my-2">
                        ...
                        <select required name="schedule_week_day" class="form-select shadow-none rounded-0">
                            <?php
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <select required name="schedule_start_time_hour" class="form-select rounded-0 shadow-none">
                                <?php
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <select required name="schedule_start_time_minute" class="form-select rounded-0 shadow-none">
                                <?php
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            ...
                            <select required name="schedule_end_time_hour" class="form-select rounded-0 shadow-none">
                                <?php
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <select required name="schedule_end_time_minute" class="form-select shadow-none rounded-0">
                                <?php
                    ...
                    <div class="my-3 row">
                        ...
                        <div class="col-6 d-grid">
                            <button type="button" class="btn btn-danger rounded-0 shadow-none" id="delete-schedule"
                                data-id="<?= $_POST["schedule_id"] ?>">Delete</button>
                        </div>
                    </div>
                </form>
            </div>
