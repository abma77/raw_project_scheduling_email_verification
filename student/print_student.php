                        ...
                        <div class="card-body">
                            <form id="filter-print-form">
                                <div class="my-2">
                                    ...
                                    <select name="print_select_semester" id="print-select-semester-student"
                                ...
                                <div class="my-2">
                                    ...
                                    <select name="print_select_school_year" id="print-select-school-year-student"
                                        class="form-select rounded-0 shadow-none">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="section-tab-pane-teacher" role="tabpanel"
                                    ...
                                    <div class="my-3 row justify-content-between">
                                        <div class="col-4 d-flex">
                                            ...
                                            <button class="btn btn-light h2 mx-2"
                                                id="print-section-student">
                                    ...
                                    <div class="my-2" id="print-timetable">
                                        <div class="my-2" id="print-student-timetable"></div>
                                    </div>
                                </div>
                                <!-- <div class="tab-pane fade" id="teacher-tab-pane-teacher" role="tabpanel"
                                    ...
                                    <div class="my-3 row justify-content-between">
                                        <div class="col-4 d-flex">
                                            <select class="form-select shadow-none rounded-0" id="print-select-teacher-teacher">
                                                <option value="">Select Teacher</option>
                                            </select>
                                            <button class="btn btn-success shadow-none rounded-0 mx-3"
