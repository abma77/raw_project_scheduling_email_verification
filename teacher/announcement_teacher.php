...
if ($_SESSION["user_type"] != "Teacher") {
    ...
    if (!empty($_SESSION["id"]) && !isset($_SESSION)) {
        ...
        // $user_name = $select->selectUserByName($_SESSION["user_fullname"]);
    }
...
<body class="bg-light">
    ...
    <?php include_once('../modals/teacher_annoucement_modals.php') ?>
    ...
    <div class="container-fluid p-0 d-flex" style="overflow-x: hidden;">
        ...
        <div class="position-relative main-content" id="plot-content" style="width: 100%;">
            ...
            <div class="row px-3 my-1">
                            ...
                            <div class="row">
                                <div class="col-12 col col-lg-12">
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control shadow-none rounded-0" placeholder="Announcement Title" name="announcement_title">
                                    </div>
                                    <div class="mt-2">
                                        <label class="form-label">Annoucement Description</label>
                                        <textarea type="text" class="form-control shadow-none rounded-0" placeholder="Announcement Description" name="announcement_desc"></textarea>
                                    </div>
                                    <div class="row mt-2">
                                        <div class="col-6 col col-lg-6">
                                            <label for="" class="form-label">Announcement Start Date</label>
                                            <select name="announcement_start_date" id="announcement_start_date" class="form-select rounded-0 shadow-none">
                                                <option value="" selected>Selected Start Date</option>
                                            </select>
                                        </div>
                                        <div class="col-6 col col-lg-6">
                                            <label for="" class="form-label">Announcement End Date</label>
                                            <select name="announcement_end_date" id="announcement_end_date" class="form-select rounded-0 shadow-none">
                                                <option value="" selected>Selected End Date</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="mt-3 d-grid">
                                        <button type="submit" class="btn btn-primary shadown-none rounded-0" id="add-announcement-btn">Add Announcement</button>
                                    </div>
                ...
                <!-- Logs section -->
                <div class="col-lg-12 col-12 shadow-sm">
