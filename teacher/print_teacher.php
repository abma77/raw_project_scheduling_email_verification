                        ...
                        <div class="card-body">
                            <form id="filter-print-form">
                                <div class="my-2">
                                    ...
                                    <select name="print_select_semester" id="print-select-semester-teacher"
                                ...
                                <div class="my-2">
                                    ...
                                    <select name="print_select_school_year" id="print-select-school-year-teacher"
                                        class="form-select rounded-0 shadow-none">
                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link nav-link-table active rounded-0" id="section-tab-teacher"
                                        data-bs-toggle="tab" data-bs-target="#section-tab-pane-teacher" type="button"
                                        role="tab" aria-controls="section-tab-pane-teacher"
                                        aria-selected="true">Section</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link nav-link-table rounded-0" id="teacher-tab-teacher"
                                        data-bs-toggle="tab" data-bs-target="#teacher-tab-pane-teacher" type="button"
                                        role="tab" aria-controls="teacher-tab-pane-teacher" aria-selected="false">My
                                        Schedule</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="section-tab-pane-teacher" role="tabpanel"
                                    aria-labelledby="section-tab-teacher" tabindex="0">
                                    ...
                                    <div class="my-2" id="print-timetable">
                                        <div class="my-2" id="print-section-timetable-teacher"></div>
                                    </div>
                                </div>
